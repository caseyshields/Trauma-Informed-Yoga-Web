...
export default class WaveSound extends Sound {
    ...
    waveEffect(intensity, length){
        ...
        this.lowPassFilter.frequency.setRampPoint("+" + this.gameSession.p5.str(length*0.4));                                    // 4
        ...
        this.highPassFilter.frequency.setRampPoint("+" + this.gameSession.p5.str(length*0.5));                                                // 5                    
        ...
        this.highPassFilter.frequency.exponentialRampToValueAtTime((this.baseHPF),"+" + this.gameSession.p5.str(length*1));                        // 10
