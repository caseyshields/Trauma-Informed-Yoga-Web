...
export default class BackButton extends Button {
    ...
    render() {
		...
		if (this.style[this.state] !== null) {
            ...
            this.p5.triangle(this.iconLayout.x1, this.iconLayout.y1, this.iconLayout.x2, this.iconLayout.y2, this.iconLayout.x3, this.iconLayout.y3);
    ...
    iconResize(){
        ...
        this.iconLayout.y3 = this.layout.y + this.layout.width * 0.50;
    }
