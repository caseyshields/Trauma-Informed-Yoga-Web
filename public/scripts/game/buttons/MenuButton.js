...
export default class MenuButton extends Button {
    ...
    iconResize(){
        ...
        this.iconLayout.line0x0 = this.layout.x + this.layout.width*.25,
        this.iconLayout.line0y0 = this.layout.y + this.layout.height*.25,
        this.iconLayout.line0x1 = this.layout.x + this.layout.width*.75,
        this.iconLayout.line0y1 = this.layout.y + this.layout.height*.25,
        this.iconLayout.circle0x = this.layout.x + this.layout.width*.25,
        this.iconLayout.circle0y = this.layout.y + this.layout.height*.25,
        this.iconLayout.circle0radius = this.layout.width*.1,
        this.iconLayout.line1x0 = this.layout.x + this.layout.width*.25,
        this.iconLayout.line1y0 = this.layout.y + this.layout.height*.50,
        this.iconLayout.line1x1 = this.layout.x + this.layout.width*.75,
        this.iconLayout.line1y1 = this.layout.y + this.layout.height*.50,
        this.iconLayout.circle1x = this.layout.x + this.layout.width*.50,
        this.iconLayout.circle1y = this.layout.y + this.layout.height*.50,
        this.iconLayout.circle1radius = this.layout.width * .1,
        this.iconLayout.line2x0 = this.layout.x + this.layout.width*.25,
        this.iconLayout.line2y0 = this.layout.y + this.layout.height*.75,
        this.iconLayout.line2x1 = this.layout.x + this.layout.width*.75,
        this.iconLayout.line2y1 = this.layout.y + this.layout.height*.75,
        this.iconLayout.circle2x = this.layout.x + this.layout.width*.75,
        this.iconLayout.circle2y = this.layout.y + this.layout.height*.75,
        this.iconLayout.circle2radius = this.layout.width * .1
    }
